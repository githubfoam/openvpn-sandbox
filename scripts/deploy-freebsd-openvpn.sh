...
echo "===========deploy openvpn================="
pkg update
pkg install --yes --quiet sudo automake autoconf fping git lzo2 liblz4 libtool mbedtls cmake

# make sure tap driver is loaded (tun automatically is)

# kldload if_tap #can't load if_tap: module already loaded or in kernel
